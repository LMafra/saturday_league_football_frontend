  ...
  const features = [
    {
      ...
      description: "Dados específicos como gols, assistências e desempenho individual com visualizações temporais personalizadas."
    },
    {
      icon: <FaRobot className="w-8 h-8 mb-4 text-green-600" />,
      title: "Automação Inteligente",
      description: "Algoritmos que organizam rodadas automaticamente, equilibrando times com base em habilidades e frequência."
    },
    {
      icon: <FaTrophy className="w-8 h-8 mb-4 text-yellow-600" />,
      title: "Histórico Competitivo",
      description: "Rankings atualizados e conquistas históricas para promover competição saudável entre jogadores."
    }
  ];
        ...
        <div className="max-w-7xl mx-auto text-center">
          ...
          >
            <h1 className="text-5xl font-bold text-white mb-6">
              Transforme Suas
              <span className="bg-gradient-to-r from-blue-400 to-blue-600 bg-clip-text text-transparent"> Peladas</span>
            </h1>
            <p className="text-xl text-gray-300 mb-8 max-w-2xl mx-auto">
              Organize, analise e evolua suas peladas com ferramentas profissionais de forma simples e intuitiva
            </p>
      ...
      <section className="py-20 px-4 sm:px-6 lg:px-8 bg-white/5 backdrop-blur-lg">
        <div className="max-w-7xl mx-auto">
          <h2 className="text-3xl font-bold text-center text-white mb-16">
            <span className="border-b-4 border-blue-500 pb-2">Vantagens Exclusivas</span>
          </h2>
